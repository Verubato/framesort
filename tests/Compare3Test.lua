...
function M:test_sort_player_top()
    ...
    assertEquals(addon:Compare("party1", "party2", addon.PlayerSortMode.Top, addon.GroupSortMode.Group), true)
    assertEquals(addon:Compare("party2", "party1", addon.PlayerSortMode.Top, addon.GroupSortMode.Group), false)
...
function M:test_sort_player_bottom()
    ...
    assertEquals(addon:Compare("party1", "party2", addon.PlayerSortMode.Bottom, addon.GroupSortMode.Group), true)
    assertEquals(addon:Compare("party2", "party1", addon.PlayerSortMode.Bottom, addon.GroupSortMode.Group), false)
...
function M:test_sort_player_middle()
    ...
    assertEquals(addon:Compare("player", "party2", addon.PlayerSortMode.Middle, addon.GroupSortMode.Group, false, presorted), true)

    assertEquals(addon:Compare("party1", "party2", addon.PlayerSortMode.Middle, addon.GroupSortMode.Group, false, presorted), true)
    assertEquals(addon:Compare("party2", "party1", addon.PlayerSortMode.Middle, addon.GroupSortMode.Group, false, presorted), false)

    assertEquals(addon:Compare("party1", "player", addon.PlayerSortMode.Middle, addon.GroupSortMode.Group, false, presorted), true)
    assertEquals(addon:Compare("party2", "player", addon.PlayerSortMode.Middle, addon.GroupSortMode.Group, false, presorted), false)
end
