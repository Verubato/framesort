...
L["Main tank and assist setting disabled"] = "주 탱커 및 지원 표시 설정 비활성화됨"
L["Please disable the 'Display Main Tank and Assist' option in Options -> Interface -> Raid Frames"] = "Options -> Interface -> Raid Frames에서 'Display Main Tank and Assist' 옵션을 비활성화하세요"
