...
L["There are some issuse that may prevent FrameSort from working correctly."] = "存在一些问题可能会阻止 FrameSort 正常工作。"
...
-- # Ordering screen #
L["Ordering"] = "顺序"
L["Specify the ordering you wish to use when sorting by role."] = "指定按职责排序时要使用的顺序。"
L["Tanks"] = "坦克"
L["Healers"] = "治疗"
L["Casters"] = "施法者"
L["Hunters"] = "猎人"
...
L["Main tank and assist setting disabled"] = "主坦和助理设置已禁用"
L["Please disable the 'Display Main Tank and Assist' option in Options -> Interface -> Raid Frames"] = "请在 选项 -> 界面 -> 团队框体 中禁用“显示主坦和助理”"
