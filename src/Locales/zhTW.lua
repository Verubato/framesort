...
L["Group"] = "隊伍"
L["Reverse"] = "反向"
L["Sort your frames while in 2v2 arena matches."] = "在 2v2 競技場對戰中排序你的框架。"
L["Sort your frames while in arena matches larger than 2v2."] = "在大於 2v2 的競技場對戰中排序你的框架。"
L["Sort the enemy frames created by supported arena addons."] = "排序由支援的競技場插件建立的敵方框架。"
L["Sort your frames while in dungeons, mythic+, and delves."] = "在地城、傳奇+與深潛中排序你的框架。"
L["Sort your frames while in raids and battlegrounds."] = "在團隊與戰場中排序你的框架。"
L["Sort your frames while in a group out in the world."] = "在野外隊伍中排序你的框架。"
L["Place your own frame at the top of the group."] = "將你自己的框架放在隊伍頂部。"
L["Place your own frame in the middle of the group."] = "將你自己的框架放在隊伍中間。"
L["Place your own frame at the bottom of the group."] = "將你自己的框架放在隊伍底部。"
L["Hide your own frame, leaving only your group members."] = "隱藏你自己的框架，只顯示隊友。"
L["Sort by the unit id, e.g. party1 > party2 > party3."] = "依單位 ID 排序，例如 party1 > party2 > party3。"
L["Sort by role and spec, using the order from the Ordering panel."] = "依職責與專精排序，使用「排序」面板中的順序。"
L["Sort by role (tank, healer, dps), using the order from the Ordering panel."] = "依職責（坦克、治療、輸出）排序，使用「排序」面板中的順序。"
L["Sort by name in alphabetical order."] = "依名稱以字母順序排序。"
L["Reverse the sort order, so the last frame becomes the first."] = "反轉排序順序，最後一個框架會變成第一個。"
